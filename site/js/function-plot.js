    ...
    var t = {
        ...
        7187: (t) => {
            ...
            (t.exports.once = function (t, n) {
              return new Promise(function (e, r) {
                ...
                y(t, n, o, { once: !0 }),
                  'error' !== n &&
                    (function (t, n, e) {
                      'function' == typeof t.on && y(t, 'error', n, { once: !0 })
                    })(t, i)
              })
            }),
            (o.EventEmitter = o),
          ...
          function c(t, n, e, r) {
            ...
            if (
              ...
              void 0 === (o = t._events)
                ...
                : (void 0 !== o.newListener && (t.emit('newListener', n, e.listener ? e.listener : e), (o = t._events)),
                  (s = o[n])),
              void 0 === s)
            )
              (s = o[n] = e), ++t._eventsCount
            else if (
              ('function' == typeof s ? (s = o[n] = r ? [e, s] : [s, e]) : r ? s.unshift(e) : s.push(e),
          ...
          Object.defineProperty(o, 'defaultMaxListeners', {
            ...
            (o.prototype.removeListener = function (t, n) {
              ...
              if (e === n || e.listener === n)
                0 == --this._eventsCount
                  ...
                  : (delete r[t], r.removeListener && this.emit('removeListener', t, e.listener || n))
                ...
                0 === i
                  ...
                  1 === e.length && (r[t] = e[0]),
                  void 0 !== r.removeListener && this.emit('removeListener', t, s || n)
              }
              return this
            }),
            ...
            (o.prototype.removeAllListeners = function (t) {
              ...
              else if (void 0 !== n) for (r = n.length - 1; r >= 0; r--) this.removeListener(t, n[r])
              return this
            }),
        ...
        4470: (t) => {
          ...
          var n = Object.prototype.hasOwnProperty,
            ...
            a = function (t, n) {
              r && '__proto__' === n.name
                ? r(t, n.name, { enumerable: !0, configurable: !0, value: n.newValue, writable: !0 })
                : (t[n.name] = n.newValue)
            },
            u = function (t, e) {
              if ('__proto__' === e) {
          ...
          t.exports = function t() {
            var n,
              ...
              d = !1
            for (
              'boolean' == typeof h && ((d = h), (h = arguments[1] || {}), (f = 2)),
              ...
              if (null != (n = arguments[f]))
                for (e in n)
                  (r = u(h, e)),
                    h !== (i = u(n, e)) &&
                      (d && i && (s(i) || (c = o(i)))
                        ? (c ? ((c = !1), (l = r && o(r) ? r : [])) : (l = r && s(r) ? r : {}),
                          a(h, { name: e, newValue: t(d, l, i) }))
                        : void 0 !== i && a(h, { name: e, newValue: i }))
            return h
          }
        },
        8867: (t, n, e) => {
          ...
          function o(t) {
            Object.keys(t).forEach(function (n) {
              ...
              'number' == typeof e || Array.isArray(e)
                ? (t[n] = i.factory(e))
                : 'object' == typeof e && 'lo' in e && 'hi' in e && (t[n] = i.factory(e.lo, e.hi))
            })
          }
          e(3380)(i),
            (t.exports = function (t) {
        ...
        9851: (t, n, e) => {
          ...
          class k {
            constructor(t, n) {
              if (((this.lo = 0), (this.hi = 0), !(this instanceof k)))
                return console.log('calling with new'), console.log(t, n), new k(t, n)
          ...
          const N = 3.141592653589793,
            ...
            P = {
              ...
              PI_TWICE_HIGH: 2 * S,
              get E() {
                return new A(E.prev(Math.E), E.next(Math.E))
              },
              get PI() {
                return new A(N, S)
              },
              get PI_HALF() {
                return new A(P.PI_HALF_LOW, P.PI_HALF_HIGH)
              },
              get PI_TWICE() {
                return new A(P.PI_TWICE_LOW, P.PI_TWICE_HIGH)
              },
              get ZERO() {
                return new A(0)
              },
              ...
              get WHOLE() {
                return new A().setWhole()
              },
              get EMPTY() {
                return new A().setEmpty()
              }
            },
            O = P
          function L(t, n) {
          ...
          function D(t, n) {
            H(t, n),
              (t = Array.isArray(t) ? t : t.toArray()),
              (n = Array.isArray(n) ? n : n.toArray()),
              Z(t[0] <= n[0], `${t[0]} should be less/equal than ${n[0]}`),
              Z(n[1] <= t[1], `${n[1]} should be less/equal than ${t[1]}`)
          }
          function $(t, n) {
          ...
          const X = q
          function B(t, n) {
            return new A(E.addLo(t.lo, n.lo), E.addHi(t.hi, n.hi))
          }
          function V(t, n) {
            return new A(E.subLo(t.lo, n.hi), E.subHi(t.hi, n.lo))
          }
          const W = V
          function G(t, n) {
                    ...
                    : (function (t, n) {
                        return 0 === t.lo && 0 === t.hi
                          ...
                          : p(t)
                            ? O.WHOLE
                            : t.hi < 0
                              ? new A(E.divLo(t.hi, n), Number.POSITIVE_INFINITY)
                              : new A(Number.NEGATIVE_INFINITY, E.divHi(t.lo, n))
                      })(t, n.lo)
                  : 0 !== n.hi
                    ? (function (t, n) {
                        return 0 === t.lo && 0 === t.hi
                          ...
                          : p(t)
                            ? O.WHOLE
                            : t.hi < 0
                              ? new A(Number.NEGATIVE_INFINITY, E.divHi(t.hi, n))
                              : new A(E.divLo(t.lo, n), Number.POSITIVE_INFINITY)
                      })(t, n.hi)
                    : O.EMPTY
                : (function (t, n) {
                    const e = t.lo,
          ...
          const K = Q
          function tt(t) {
            return new A(t.lo, t.hi)
          }
          function nt(t) {
            return new A(-t.hi, -t.lo)
          }
          function et(t, n) {
            if (l(t) || l(n)) return O.EMPTY
            const e = t.lo < 0 ? n.lo : n.hi
            let r = t.lo / e
            return (r = r < 0 ? Math.ceil(r) : Math.floor(r)), W(t, J(n, new A(r)))
          }
          function rt(t) {
            return l(t)
              ? O.EMPTY
              : p(t)
                ? 0 !== t.lo
                  ? 0 !== t.hi
                    ? O.WHOLE
                    : new A(Number.NEGATIVE_INFINITY, E.divHi(1, t.lo))
                  : 0 !== t.hi
                    ? new A(E.divLo(1, t.hi), Number.POSITIVE_INFINITY)
                    : O.EMPTY
                : new A(E.divLo(1, t.hi), E.divHi(1, t.lo))
          }
          function it(t, n) {
            ...
            if (Number.isSafeInteger(n)) {
              ...
              return t.lo < 0
                ? 1 == (1 & n)
                  ? new A(-E.powLo(-t.lo, n), E.powHi(t.hi, n))
                  : new A(0, E.powHi(Math.max(-t.lo, t.hi), n))
                : new A(E.powLo(t.lo, n), E.powHi(t.hi, n))
            }
            return (
          ...
          function at(t) {
            return l(t) ? O.EMPTY : new A(E.expLo(t.lo), E.expHi(t.hi))
          }
          function ut(t) {
            if (l(t)) return O.EMPTY
            const n = t.lo <= 0 ? Number.NEGATIVE_INFINITY : E.logLo(t.lo)
            return new A(n, E.logHi(t.hi))
          }
          const ct = ut,
            lt = ut(new A(10, 10))
          function ht(t) {
          ...
          function dt(t, n) {
            const e = l(t),
              r = l(n)
            return e && r ? O.EMPTY : e ? n.clone() : r ? t.clone() : new A(Math.min(t.lo, n.lo), Math.max(t.hi, n.hi))
          }
          function yt(t, n) {
            if (l(t) || l(n)) return O.EMPTY
            const e = Math.max(t.lo, n.lo),
              r = Math.min(t.hi, n.hi)
            return e <= r ? new A(e, r) : O.EMPTY
          }
          function _t(t, n) {
            if (!_(t, n)) throw Error('Interval#union: intervals do not overlap')
            return new A(Math.min(t.lo, n.lo), Math.max(t.hi, n.hi))
          }
          function mt(t, n) {
            if (l(t) || h(n)) return O.EMPTY
            if (_(t, n)) {
              if (t.lo < n.lo && n.hi < t.hi) throw Error('Interval.difference: difference creates multiple intervals')
              return (n.lo <= t.lo && n.hi === 1 / 0) || (n.hi >= t.hi && n.lo === -1 / 0)
                ? O.EMPTY
                : n.lo <= t.lo
                  ? new A().halfOpenLeft(n.hi, t.hi)
                  : new A().halfOpenRight(t.lo, n.lo)
            }
            return t.clone()
          }
          function gt(t) {
          ...
          const vt = gt
          function xt(t) {
            return l(t) || h(t) ? O.EMPTY : t.lo >= 0 ? t.clone() : t.hi <= 0 ? nt(t) : new A(0, Math.max(-t.lo, t.hi))
          }
          function wt(t, n) {
            const e = l(t),
              r = l(n)
            return e && r ? O.EMPTY : e ? n.clone() : r ? t.clone() : new A(Math.max(t.lo, n.lo), Math.max(t.hi, n.hi))
          }
          function bt(t, n) {
            const e = l(t),
              r = l(n)
            return e && r ? O.EMPTY : e ? n.clone() : r ? t.clone() : new A(Math.min(t.lo, n.lo), Math.min(t.hi, n.hi))
          }
          function Mt(t) {
          ...
          function kt(t) {
            ...
            const n = new A().set(t.lo, t.hi)
            Et(n)
            const e = O.PI_TWICE,
              r = et(n, e)
            if (gt(r) >= e.lo) return new A(-1, 1)
            if (r.lo >= O.PI_HIGH) return nt(kt(W(r, O.PI)))
            const i = r.lo,
              o = r.hi,
              s = E.cosLo(o),
              a = E.cosHi(i)
            return o <= O.PI_LOW ? new A(s, a) : o <= e.lo ? new A(-1, Math.max(s, a)) : new A(-1, 1)
          }
          function At(t) {
          ...
          function Nt(t) {
            ...
            let r = et(n, e)
            return (
              r.lo >= O.PI_HALF_LOW && (r = W(r, e)),
              r.lo <= -O.PI_HALF_LOW || r.hi >= O.PI_HALF_LOW ? O.WHOLE : new A(E.tanLo(r.lo), E.tanHi(r.hi))
            )
          }
          function St(t) {
          ...
          function Ot(t) {
            return l(t) ? O.EMPTY : new A(E.atanLo(t.lo), E.atanHi(t.hi))
          }
          function Lt(t) {
            return l(t) ? O.EMPTY : new A(E.sinhLo(t.lo), E.sinhHi(t.hi))
          }
          function It(t) {
            return l(t)
              ? O.EMPTY
              : t.hi < 0
                ? new A(E.coshLo(t.hi), E.coshHi(t.lo))
                : t.lo >= 0
                  ? new A(E.coshLo(t.lo), E.coshHi(t.hi))
                  : new A(1, E.coshHi(-t.lo > t.hi ? t.lo : t.hi))
          }
          function Zt(t) {
            return l(t) ? O.EMPTY : new A(E.tanhLo(t.lo), E.tanhHi(t.hi))
          }
          const Ct = Object.assign(A, O, E, a, r, i, o, s, u, { round: E })
        },
        2223: (t, n, e) => {
          'use strict'
          t.exports = e(3829)
        ...
        3829: (t, n, e) => {
          ...
          ;(s.prototype.setDefs = function (t) {
            ...
            (s.prototype.compile = function (t) {
              ...
              const e = Object.keys(this.defs).map(function (t) {
                return 'var ' + t + ' = defs["' + t + '"]'
              })
        ...
        6009: (t, n, e) => {
          ...
          const r = e(4470),
            ...
            o = function (t, n) {
              ...
              const e = this.options.factory
              if ('string' != typeof e || !/^[a-zA-Z_$][a-zA-Z0-9_$]*(\.[a-zA-Z_$][a-zA-Z0-9_$]*)*$/.test(e))
        ...
        6408: (t) => {
          'use strict'
          t.exports = function (t) {
            return 'scope[' + JSON.stringify(t.name) + '] = ' + this.next(t.expr)
          }
        },
        9907: (t) => {
          'use strict'
        ...
        2341: (t) => {
          'use strict'
          t.exports = function (t) {
            if (this.options.raw) return t.value
            const n = 'string' === t.valueType ? JSON.stringify(t.value) : t.value
            return this.options.factory + '(' + n + ')'
          }
        },
        7850: (t, n, e) => {
          'use strict'
          const r = e(9213).nodeTypes.SymbolNode,
            i = function (t) {
              return '$$mathCodegen.functionProxy(' + this.next(new r(t.name)) + ', ' + JSON.stringify(t.name) + ')'
            }
          ;(t.exports = function (t) {
            const n = this,
              e = i.call(this, t)
        ...
        6656: (t) => {
          ...
          t.exports = function (t) {
            const n = t.name
            return '$$mathCodegen.getProperty(' + JSON.stringify(n) + ', scope, ns)'
          }
        },
        2386: (t, n, e) => {
          'use strict'
            ...
            (h.prototype.lex = function (t) {
              for (this.text = t, this.index = 0, this.tokens = []; this.index < this.text.length; ) {
                ...
                var n = this.peek(),
                  ...
                  i = e + this.peek(2)
                c(i)
                  ? (this.tokens.push({ type: r.DELIMITER, value: i }), this.consume(), this.consume(), this.consume())
                  : c(e)
                    ? (this.tokens.push({ type: r.DELIMITER, value: e }), this.consume(), this.consume())
                    : c(n)
                      ? (this.tokens.push({ type: r.DELIMITER, value: n }), this.consume())
                      : s(n) || ('.' === n && s(this.peek(1)))
                        ? this.tokens.push({ type: r.NUMBER, value: this.readNumber() })
                        : l(n)
                          ? this.tokens.push({ type: r.STRING, value: this.readString() })
                          : a(n)
                            ? this.tokens.push({ type: r.SYMBOL, value: this.readIdentifier() })
        ...
        3093: (t, n, e) => {
          ...
          t.exports = function (t, n) {
            ...
            var e = r.hi(t),
              s = r.lo(t)
            return (
              n > t == t > 0 ? (s === o ? ((e += 1), (s = 0)) : (s += 1)) : 0 === s ? ((s = o), (e -= 1)) : (s -= 1),
              r.pack(s, e)
            )
          }
        },
          ...
          class g extends h.default.EventEmitter {
            ...
            internalVars() {
              ...
              this.options.title && (this.meta.margin.top = 40),
                (this.meta.width = (this.options.width || _.default.DEFAULT_WIDTH) - t.left - t.right),
                (this.meta.height = (this.options.height || _.default.DEFAULT_HEIGHT) - t.top - t.bottom),
                this.initializeAxes()
            }
            initializeAxes() {
              const t = this,
              ...
              const r = (this.meta.xDomain = (function (t) {
                ...
                s = (this.meta.yDomain = (function (n) {
              ...
              this.meta.xScale || (this.meta.xScale = m(this.options.xAxis.type)()),
                this.meta.xScale
                  .domain(r)
                  .range(this.options.xAxis.invert ? [this.meta.width, 0] : [0, this.meta.width]),
                this.meta.yScale || (this.meta.yScale = m(this.options.yAxis.type)()),
                this.meta.yScale
                  .domain(s)
                  .range(this.options.yAxis.invert ? [0, this.meta.height] : [this.meta.height, 0]),
                this.meta.xAxis || (this.meta.xAxis = (0, a.axisBottom)(this.meta.xScale)),
                this.meta.xAxis.tickSize(this.options.grid ? -this.meta.height : 0).tickFormat(e),
                this.meta.yAxis || (this.meta.yAxis = (0, a.axisLeft)(this.meta.yScale)),
                this.meta.yAxis.tickSize(this.options.grid ? -this.meta.width : 0).tickFormat(e),
                (this.line = (0, i.line)()
                  .x(function (n) {
            ...
            drawGraphWrapper() {
              const t = (this.root = (0, c.select)(this.options.target).selectAll('svg').data([this.options]))
              ;(this.root.enter = t
                .enter()
                .append('svg')
                ...
                this.buildAxis(),
                this.buildAxisLabel()
              const n = (this.tip = (0, p.default)(Object.assign(this.options.tip || {}, { owner: this })))
            ...
            buildContent() {
              ...
              if ('linear' === this.options.xAxis.type) {
                const t = e
                  ...
                  n = t.enter().append('path').attr('class', 'y origin').attr('stroke', 'black').attr('opacity', 0.2)
              ...
              if ('linear' === this.options.yAxis.type) {
                const t = e
                  ...
                  n = t.enter().append('path').attr('class', 'x origin').attr('stroke', 'black').attr('opacity', 0.2)
                t.merge(n).attr('d', this.line)
              }
              e.merge(r).call((0, f.default)({ owner: t }))
              const i = e
                .merge(r)
                .selectAll(':scope > g.graph')
                .data(
                  (t) => t.data.map(y.default),
                  (t) => t.fn || t.r || t.x || t.text
                )
              i.exit().remove()
              const o = i.enter().append('g').attr('class', 'graph')
              i.merge(o).each(function (n, e) {
                n.index = e
                const r = (0, c.select)(this)
                r.call(_.default.graphTypes[n.graphType](t)), r.call((0, d.default)(t))
              })
            }
            buildZoomHelper() {
              const t = this
              this.meta.zoomBehavior ||
                ((this.meta.zoomBehavior = (0, u.zoom)().on('zoom', function (n) {
            ...
            updateAxes() {
              ...
              if ((n.select('.x.axis').call(t.meta.xAxis), 'sticky' === this.options.xAxis.position)) {
                const t = this.meta.yScale.domain()[0],
                  e = this.meta.yScale.domain()[1],
                  r = (e + t) / 2
                let i = (this.meta.height / (e - t)) * r + this.meta.height / 2
                ;(i = i < 0 ? 0 : i),
                  (i = i > this.meta.height ? this.meta.height : i),
                  n.select('.x.axis').attr('transform', 'translate(0,' + i + ')'),
                  n
                    .selectAll('.x.axis path, .x.axis line')
                    .attr('transform', 'translate(0,' + (this.meta.height / 2 - i + this.meta.height / 2) + ')')
              }
              if ((n.select('.y.axis').call(t.meta.yAxis), 'sticky' === this.options.yAxis.position)) {
                const t = this.meta.xScale.domain()[0],
                  e = this.meta.xScale.domain()[1],
                  r = (e + t) / 2
                let i = (this.meta.width / (t - e)) * r + this.meta.width / 2
                ;(i = i < 0 ? 0 : i),
                  (i = i > this.meta.width ? this.meta.width : i),
                  n.select('.y.axis').attr('transform', 'translate(' + i + ',0)'),
                  n.selectAll('.y.axis path, .y.axis line').attr('transform', 'translate(' + -i + ',0)')
              }
              n.selectAll('.axis path, .axis line')
                .attr('fill', 'none')
                .attr('stroke', 'black')
            ...
            setUpEventListeners() {
              ...
              const e = {
                  ...
                  zoom: function ({ transform: n }) {
                    ...
                    const e = n.rescaleX(t.meta.zoomBehavior.xScale).interpolate(l.interpolateRound),
                  ...
                  'tip:update': function ({ x: n, y: e, index: r }) {
                    ...
                    o && a.push(o),
                      a.push(s(n, e)),
                      t.root.select('.top-right-legend').attr('fill', _.default.COLORS[r]).text(a.join(' '))
                  }
                },
                r = {
                  mousemove: function (n) {
                    const e = (0, c.pointer)(n, t.draggable.node()),
        ...
        6025: function (t, n, e) {
          ...
          n.default = function (t, n) {
            ...
            let r
            if ('builtIn' === n.sampler) r = s.default
            else {
              if ('interval' !== n.sampler) throw new Error(`Invalid sampler function ${n.sampler}`)
              r = o.default
            }
            const a =
                n.nSamples || Math.min(i.default.MAX_ITERATIONS, i.default.DEFAULT_ITERATIONS || 2 * t.meta.width),
              u = r({
                d: n,
                range: e,
            ...
            return t.emit('eval', u, n.index, n.isHelper), u
          }
        },
        5888: (t, n, e) => {
          'use strict'
          Object.defineProperty(n, '__esModule', { value: !0 }), (n.registerGraphType = void 0)
          const r = e(6618),
            i = {
              COLORS: ['steelblue', 'red', '#05b378', 'orange', '#4040e8', 'yellow', 'brown', 'magenta', 'cyan'].map(
                function (t) {
                  return (0, r.hsl)(t)
                }
              ),
          ...
          ;(i.MAX_ITERATIONS = 10 * i.DEFAULT_WIDTH),
            (n.registerGraphType = function (t, n) {
              if (Object.hasOwn(i.graphTypes, t))
        ...
        3321: function (t, n, e) {
          ...
          Object.defineProperty(n, '__esModule', { value: !0 }), (n.text = n.scatter = n.interval = n.polyline = void 0)
          const i = r(e(2210))
          ...
          n.default = function (t) {
            ...
            return function u(c) {
              c.each(function (c) {
                ...
                const y = `line line-${h}`,
                  _ = d.enter().append('path').attr('class', y).attr('fill', 'none'),
                  m = d
                    .merge(_)
                    .attr('stroke-width', n)
                ...
                if (c.attr)
                  for (const t in c.attr) {
                    let n = c.attr[t]
                    'class' === t && (n = `${y} ${c.attr[t]}`), m.attr(t, n)
                  }
                d.exit().remove()
              })
            }
            ...
            return function n(e) {
              e.each(function (e) {
                const r = (n.el = (0, i.select)(this)),
                  u = e.index,
                  c = (0, a.default)(t, e),
                  l = s.default.color(e, u),
                  h = r.selectAll(':scope > path.line').data(c),
                  f = t.meta.yScale.range()
                let p = f[0],
                  d = f[1]
                const y = p - d
                function _(n) {
                  return s.default.clamp(t.meta.yScale(n[1]), d, p)
                }
                ;(p += 1e6 * y),
                  (d -= 1e6 * y),
                  e.skipBoundsCheck && ((p = s.default.infinity()), (d = -s.default.infinity()))
                const m = (0, o.line)()
                    .curve(o.curveLinear)
                    .x(function (n) {
                      return t.meta.xScale(n[0])
                  ...
                  g = (0, o.area)()
                    ...
                    .y1(_),
                  v = `line line-${u}`,
                  x = h.enter().append('path').attr('class', v).attr('stroke-width', 1).attr('stroke-linecap', 'round')
                h.merge(x).each(function () {
                  const n = (0, i.select)(this)
                  let r
                  if (
                    (e.closed
                      ? (n.attr('fill', l), n.attr('fill-opacity', 0.3), (r = g))
                      : (n.attr('fill', 'none'), (r = m)),
                    n
                      .attr('stroke', l)
                    ...
                    for (const t in e.attr) {
                      let r = e.attr[t]
                      'class' === t && (r = `${v} ${e.attr[t]}`), n.attr(t, r)
                    }
                }),
                  h.exit().remove()
              })
            ...
            return function (r) {
              r.each(function (r) {
                ...
                const l = r.index,
                  ...
                  f = (0, a.default)(t, r),
                  p = []
                for (u = 0; u < f.length; u += 1) for (c = 0; c < f[u].length; c += 1) p.push(f[u][c])
                const d = (0, i.select)(this).selectAll(':scope > circle.scatter').data(p),
                  y = `scatter scatter-${l}`,
                  _ = d.enter().append('circle').attr('class', y),
                  m = d
                    .merge(_)
                    .attr('fill', (0, o.hsl)(h.toString()).brighter(1.5).formatHex())
                    .attr('stroke', h)
                    .attr('opacity', 0.7)
                    .attr('r', 1)
                    .attr('cx', function (t) {
                ...
                if (r.attr)
                  for (const t in r.attr) {
                    let n = r.attr[t]
                    'class' === t && (n = `${y} ${r.attr[t]}`), m.attr(t, n)
                  }
                d.exit().remove()
              })
            }
          ...
          n.default = function (t) {
            ...
            return function (t) {
              t.each(function (t) {
                ...
                const r = (0, i.select)(this).selectAll(':scope > text.fn-text').data([t.location]),
                  a = r.enter().append('text').attr('class', `fn-text fn-text-${t.index}`),
                  u = s.default.color(t, t.index),
                  c = r
                    .merge(a)
                    .attr('fill', (0, o.hsl)(u.toString()).brighter(1.5).formatHex())
                    .attr('x', (t) => n(t[0]))
                    .attr('y', (t) => e(t[1]))
                    .text(() => t.text)
                if (t.attr) for (const n in t.attr) c.attr(n, t.attr[n])
                r.exit().remove()
              })
            }
          }
            ...
            return function (t) {
              t.each(function () {
                const t = (0, i.select)(this)
                  ...
                  c = u.enter().append('path')
                u.merge(c).attr('stroke', '#eee').attr('d', o), u.exit().remove()
                const l = t
                    .merge(r)
                    .selectAll('text')
                    .data(function (t) {
        ...
        8016: function (t, n, e) {
          ...
          n.default = function (t) {
            ...
            function e(t) {
              ...
              const e = 'number' == typeof t.derivative.x0 ? t.derivative.x0 : u.default.infinity()
              return (
                (n.index = t.index),
                (n.scope = {
            ...
            function r(n) {
              ...
              n.derivative &&
                ...
                ((n.derivative.$$mouseListener = function ({ x: t }) {
                  n.derivative && (n.derivative.x0 = t), c(e)
                }),
                ...
                (function (n, e) {
                  ...
                  r !== n[i] &&
                    ...
                    (n[a] = (function (n) {
                      if ('string' == typeof n) {
                        const e = o[t](n)
                        return s && 'builtIn' === t ? { eval: e.evaluate || e.eval } : e
                      }
        ...
        9793: function (t, n, e) {
          ...
          n.default = function (t) {
            ...
            function e(t, n) {
              ...
              n.scope = n.scope || {}
              const e = n.x0,
                r = 'number' == typeof n.x1 ? n.x1 : u.default.infinity()
              var i
            ...
            function l(t) {
              ...
              for (let o = 0; o < t.secants.length; o += 1) {
                ...
                ;(s.index = t.index), s.fn || (r.call(e, t, s), c.call(e, t, s)), i.push(s)
              }
              return i
            }
            function h(n) {
              n.each(function (e) {
                ...
                s.merge(u).call((0, a.polyline)(t)),
                  s.merge(u).selectAll('path').attr('opacity', 0.5),
                  s.exit().remove()
              })
            }
            return h
        ...
        3607: function (t, n, e) {
          ...
          const u = o(e(5888))
          Object.defineProperty(n, 'registerGraphType', {
            enumerable: !0,
            get: function () {
              return u.registerGraphType
            }
          })
          const c = e(3321),
            l = o(e(1669))
          function h(t) {
            ...
            return n || (n = new a.Chart(t)), n.build()
          }
          ;(0, u.registerGraphType)('polyline', c.polyline),
            (0, u.registerGraphType)('interval', c.interval),
            (0, u.registerGraphType)('scatter', c.scatter),
            (0, u.registerGraphType)('text', c.text),
            (n.default = h),
            (h.globals = u.default),
            (h.$eval = l),
        ...
        7777: function (t, n, e) {
          ...
          function s(t, n, e, r, a) {
            if (!a) return { asymptote: !0, d0: t, d1: n }
            const u = t[0],
              c = n[0],
              l = i.default.linspace(u, c, 10)
            let h, f
            for (let t = 0; t < 10; t += 1) {
              const n = l[t],
                u = (0, o.builtIn)(e, 'fn', { x: n })
              if (h) {
                const t = u - h
                if (i.default.sgn(t) === r) return s([f, h], [n, u], e, r, a - 1)
              }
              ;(h = u), (f = n)
            }
          ...
          function a(t) {
            const n = i.default.space(t.xAxis, t.range, t.nSamples),
              e = t.yScale.domain(),
              r = e[0] - i.default.infinity(),
              a = e[1] + i.default.infinity(),
              u = []
            for (let e = 0; e < n.length; e += 1) {
              const s = n[e]
              let c = (0, o.builtIn)(t.d, 'fn', { x: s })
              i.default.isValidNumber(s) &&
                i.default.isValidNumber(c) &&
                ((c = i.default.clamp(c, r, a)), u.push([s, c]))
            }
            const c = (function (t, n, e) {
              let r
              const o = [],
                a = e.domain()[0] - i.default.infinity(),
                u = e.domain()[1] + i.default.infinity()
              let c = [n[0]],
                l = 1,
                h = i.default.infinity()
              for (; l < n.length; ) {
                const e = n[l - 1][1],
                  f = n[l][1] - e,
                  p = i.default.sgn(f)
                if (c.length >= 2 && r !== p && Math.abs(f / h) > 1) {
                  const e = s(n[l - 1], n[l], t, p, 3)
                  e.asymptote
                    ? ((n[l - 1][0] = e.d0[0]),
                      (n[l - 1][1] = i.default.clamp(e.d0[1], a, u)),
                      o.push(c),
                      (n[l][0] = e.d1[0]),
                      (n[l][1] = i.default.clamp(e.d1[1], a, u)),
                      (c = [n[l]]))
                    : c.push(n[l])
                } else c.push(n[l])
                c.length > 1 && ((h = c[c.length - 1][0] - c[c.length - 2][0]), (r = p)), ++l
              }
          ...
          function u(t) {
            const n = t.d.range || [0, 2 * Math.PI],
              e = i.default.space(t.xAxis, n, t.nSamples),
              r = []
            for (let n = 0; n < e.length; n += 1) {
              const i = e[n],
                s = (0, o.builtIn)(t.d, 'x', { t: i }),
                a = (0, o.builtIn)(t.d, 'y', { t: i })
              r.push([s, a])
            }
            return [r]
          }
          function c(t) {
            const n = t.d.range || [-Math.PI, Math.PI],
              e = i.default.space(t.xAxis, n, t.nSamples),
              r = []
            for (let n = 0; n < e.length; n += 1) {
              const i = e[n],
                s = (0, o.builtIn)(t.d, 'r', { theta: i }),
                a = s * Math.cos(i),
                u = s * Math.sin(i)
              r.push([a, u])
            }
          ...
          function h(t) {
            const n = t.d
            return (n.offset = n.offset || [0, 0]), [[n.offset, [n.vector[0] + n.offset[0], n.vector[1] + n.offset[1]]]]
          }
          n.default = function (t) {
            const n = { parametric: u, polar: c, points: l, vector: h, linear: a }
            if (!(t.d.fnType in n)) throw Error(t.d.fnType + ' is not supported in the `builtIn` sampler')
            return n[t.d.fnType].apply(null, arguments)
          }
        },
        8458: function (t, n, e) {
          'use strict'
          ...
          const a = o(e(8867)),
            ...
            c = s(e(8593))
          function l(t) {
            const n = c.default.space(t.xAxis, t.range, t.nSamples),
              e = t.xScale,
              r = t.yScale,
              i = r.domain()[0],
              o = r.domain()[1],
              s = []
            let l
            for (l = 0; l < n.length - 1; l += 1) {
              const e = { lo: n[l], hi: n[l + 1] },
                r = (0, u.interval)(t.d, 'fn', { x: e })
              a.Interval.isEmpty(r) || a.Interval.isWhole(r) || s.push([e, r]), a.Interval.isWhole(r) && s.push(null)
            }
            for (l = 1; l < s.length - 1; l += 1)
              if (!s[l]) {
                const t = s[l - 1],
                  n = s[l + 1]
                t &&
                  ...
                  (t[1].lo > n[1].hi && ((t[1].hi = Math.max(o, t[1].hi)), (n[1].lo = Math.min(i, n[1].lo))),
                  t[1].hi < n[1].lo && ((t[1].lo = Math.min(i, t[1].lo)), (n[1].hi = Math.max(o, n[1].hi))))
              }
            return (s.scaledDx = e(n[1]) - e(n[0])), [s]
          }
          let h
          function f(t, n, e) {
            const r = (0, u.interval)(e, 'fn', { x: t, y: n })
          ...
          function p(t) {
            const n = t.xScale,
              ...
              o = { lo: r[0], hi: r[1] },
              s = []
            return (h = n.invert(1) - n.invert(0)), f.call(s, i, o, t.d), (s.scaledDx = 1), [s]
          }
          a.default.policies.disableRounding(),
            (n.default = function (t) {
              const n = { implicit: p, linear: l }
              if (!Object.hasOwn(n, t.d.fnType)) throw Error(t.d.fnType + ' is not supported in the `interval` sampler')
              return n[t.d.fnType].apply(null, arguments)
            })
        },
        953: function (t, n, e) {
            ...
            return (
              (h.move = function (e) {
                ...
                for (r = 0; r < _.length; r += 1) {
                  ...
                  const t = _[r].range || [-s.default.infinity(), s.default.infinity()]
                  let n
                  if (w > t[0] - a.default.TIP_X_EPS && w < t[1] + a.default.TIP_X_EPS) {
                    try {
                      n = (0, u.builtIn)(_[r], 'fn', { x: w })
                    } catch (t) {}
                    if (s.default.isValidNumber(n)) {
                ...
                if (-1 !== p) {
                  ;(i = w),
                    _[p].range && ((i = Math.max(i, _[p].range[0])), (i = Math.min(i, _[p].range[1]))),
                    (o = (0, u.builtIn)(_[p], 'fn', { x: i })),
                    h.show(),
                    t.owner.emit('tip:update', { x: i, y: o, index: p })
                  const e = s.default.clamp(i, m.invert(-20), m.invert(v + n)),
                    r = s.default.clamp(o, g.invert(x + n), g.invert(-20)),
                    a = s.default.color(_[p], p)
                  d.style('color', 'red'),
                    d.attr('transform', 'translate(' + m(e) + ',' + g(r) + ')'),
                    d.select('circle').attr('fill', a),
                    d
                      .select('text')
                      .attr('fill', a)
                      .text(t.renderer(i, o, p))
                } else h.hide()
              }),
              (h.show = function () {
                c.merge(l).style('display', null)
              }),
              (h.hide = function () {
                c.merge(l).style('display', 'none')
              }),
              Object.keys(t).forEach(function (n) {
                s.default.getterSetter.call(h, t, n)
              }),
              h
            )
          }
          ...
          const i = r(e(5888)),
            o = {
              ...
              space: function (t, n, e) {
                const r = n[0],
                  i = n[1]
                return 'log' === t.type ? this.logspace(Math.log10(r), Math.log10(i), e) : this.linspace(r, i, e)
              },
              ...
              color: function (t, n) {
                const e = n % i.default.COLORS.length
        ...
        8873: (t, n, e) => {
          ...
          e.r(n), e.d(n, { axisBottom: () => m, axisLeft: () => g, axisRight: () => _, axisTop: () => y })
          var i = 1,
            o = 2,
            s = 3,
            a = 4,
          ...
          function d(t, n) {
            var e = [],
              ...
              m = 6,
              g = 3,
              v = 'undefined' != typeof window && window.devicePixelRatio > 1 ? 0 : 0.5,
              x = t === i || t === a ? -1 : 1,
              w = t === a || t === o ? 'x' : 'y',
              b = t === i || t === s ? c : l
            function M(c) {
              ...
              ;(P = P.merge(P.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', 'currentColor'))),
                ...
                (C = C.merge(
                  I.append('text')
                    ...
                    .attr(w, x * T)
                    .attr('dy', t === i ? '0em' : t === s ? '0.71em' : '0.32em')
                )),
                c !== S &&
                  ((P = P.transition(c)),
                  (O = O.transition(c)),
                  ...
                  (L = L.transition(c)
                    .attr('opacity', u)
                    .attr('transform', function (t) {
                      return isFinite((t = N(t))) ? b(t + v) : this.getAttribute('transform')
                    })),
                  I.attr('opacity', u).attr('transform', function (t) {
                    var n = this.parentNode.__axis
                    return b((n && isFinite((n = n(t))) ? n : N(t)) + v)
                  })),
                L.remove(),
                P.attr(
                  'd',
                  t === a || t === o
                    ? m
                      ? 'M' + x * m + ',' + k + 'H' + v + 'V' + A + 'H' + x * m
                      : 'M' + v + ',' + k + 'V' + A
                    : m
                      ? 'M' + k + ',' + x * m + 'V' + v + 'H' + A + 'V' + x * m
                      : 'M' + k + ',' + v + 'H' + A
                ),
                O.attr('opacity', 1).attr('transform', function (t) {
                  return b(N(t) + v)
                }),
                Z.attr(w + '2', x * _),
                C.attr(w, x * T).text(M),
                S.filter(p)
                  ...
                  .attr('text-anchor', t === o ? 'start' : t === a ? 'end' : 'middle'),
                S.each(function () {
                  this.__axis = N
                })
            }
            return (
              ...
              (M.tickSize = function (t) {
                return arguments.length ? ((_ = m = +t), M) : _
              }),
        ...
        4447: (t, n, e) => {
            ...
            return (
              ...
              (n = l.exec(t))
                ? ((e = n[1].length),
                  ...
                  6 === e
                    ...
                    : 3 === e
                      ...
                      : 8 === e
                        ? b((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255)
                        : 4 === e
                          ? b(
                              ((n >> 12) & 15) | ((n >> 8) & 240),
                              ((n >> 8) & 15) | ((n >> 4) & 240),
                ...
                : (n = h.exec(t))
                  ? new E(n[1], n[2], n[3], 1)
                  : (n = f.exec(t))
                    ? new E((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
                    : (n = p.exec(t))
                      ? b(n[1], n[2], n[3], n[4])
                      : (n = d.exec(t))
                        ? b((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
                        : (n = y.exec(t))
          ...
          function O(t, n, e, r) {
            return (
              r <= 0 ? (t = n = e = NaN) : e <= 0 || e >= 1 ? (t = n = NaN) : n <= 0 && (t = NaN), new Z(t, n, e, r)
            )
          }
          function L(t) {
            ...
            return (
              u
                ? ((a = n === s ? (e - r) / u + 6 * (e < r) : e === s ? (r - n) / u + 2 : (n - e) / u + 4),
                  (u /= c < 0.5 ? s + o : 2 - s - o),
                  (a *= 60))
                : (u = c > 0 && c < 1 ? 0 : a),
              new Z(a, u, c, t.opacity)
            )
          }
          function I(t, n, e, r) {
          ...
          ;(0, r.Z)(i, x, {
            ...
            (0, r.Z)(
              ...
              (0, r.l)(i, {
                ...
                clamp() {
                  return new E(S(this.r), S(this.g), S(this.b), N(this.opacity))
                },
                displayable() {
                  return (
                    -0.5 <= this.r &&
            ...
            (0, r.Z)(
              ...
              (0, r.l)(i, {
                ...
                clamp() {
                  return new Z(C(this.h), H(this.s), H(this.l), N(this.opacity))
                },
                displayable() {
                  return (
                ...
                formatHsl() {
                  const t = N(this.opacity)
                  return `${1 === t ? 'hsl(' : 'hsla('}${C(this.h)}, ${100 * H(this.s)}%, ${100 * H(this.l)}%${1 === t ? ')' : `, ${t})`}`
                }
              })
            )
        },
            ...
            return 1 === arguments.length
              ? (function (t) {
                  ...
                  var n = t.r / 255,
                    ...
                    a = r - s,
                    d = (l * (e - s) - u * a) / c,
                    _ = Math.sqrt(d * d + a * a) / (l * s * (1 - s)),
                    m = _ ? Math.atan2(d, a) * o.R - 120 : NaN
                  return new y(m < 0 ? m + 360 : m, _, s, t.opacity)
                })(t)
              : new y(t, n, e, null == r ? 1 : r)
          }
          function y(t, n, e, r) {
            ;(this.h = +t), (this.s = +n), (this.l = +e), (this.opacity = +r)
          }
        ...
        8990: (t, n, e) => {
          ...
          const s = 0.96422,
            ...
            f = l * l * l
          function p(t) {
            if (t instanceof _) return new _(t.l, t.a, t.b, t.opacity)
            ...
            var n,
              ...
              o = x(t.g),
              c = x(t.b),
              l = m((0.2225045 * r + 0.7168786 * o + 0.0606169 * c) / a)
            return (
              r === o && o === c
                ? (n = e = l)
                : ((n = m((0.4360747 * r + 0.3850649 * o + 0.1430804 * c) / s)),
                  (e = m((0.0139322 * r + 0.0971045 * o + 0.7141733 * c) / u))),
              new _(116 * l - 16, 500 * (n - l), 200 * (l - e), t.opacity)
            )
          }
          function d(t, n) {
            return new _(t, 0, 0, null == n ? 1 : n)
          }
          function y(t, n, e, r) {
            return 1 === arguments.length ? p(t) : new _(t, n, e, null == r ? 1 : r)
          }
          function _(t, n, e, r) {
          ...
          function w(t) {
            ...
            if ((t instanceof _ || (t = p(t)), 0 === t.a && 0 === t.b))
          ...
          function E(t) {
            if (isNaN(t.h)) return new _(t.l, 0, 0, t.opacity)
            var n = t.h * o.u
            return new _(t.l, Math.cos(n) * t.c, Math.sin(n) * t.c, t.opacity)
          }
          ;(0, r.Z)(
            _,
            y,
            (0, r.l)(i.Il, {
              brighter(t) {
                return new _(this.l + 18 * (null == t ? 1 : t), this.a, this.b, this.opacity)
              },
              darker(t) {
                return new _(this.l - 18 * (null == t ? 1 : t), this.a, this.b, this.opacity)
              },
              rgb() {
                ...
                return (
                  ...
                  (e = u * g(e)),
                  new i.Ss(
                    v(3.1338561 * n - 1.6168667 * t - 0.4906146 * e),
                    v(-0.9787684 * n + 1.9161415 * t + 0.033454 * e),
                    v(0.0719453 * n - 0.2289914 * t + 1.4052427 * e),
                    this.opacity
                  )
                )
              }
          ...
          function f(t) {
              ...
              s =
                void 0 === t.grouping || void 0 === t.thousands
                  ...
                  : ((n = l.call(t.grouping, Number)),
                    ...
                    function (t, r) {
                      for (
                        var i = t.length, o = [], s = 0, a = n[0], u = 0;
                        i > 0 &&
                        a > 0 &&
            ...
            function g(t) {
              var n = (t = (0, o.Z)(t)).fill,
                ...
                w = t.trim,
                b = t.type
              'n' === b ? ((v = !0), (b = 'g')) : u[b] || (void 0 === x && (x = 12), (w = !0), (b = 'g')),
                (l || ('0' === n && '=' === e)) && ((l = !0), (n = '0'), (e = '='))
              ...
              function A(t) {
                ...
                switch ((v && l && ((t = s(N + t, N.length ? g - f.length : 1 / 0)), (N = '')), e)) {
                  case '<':
                    t = c + t + f + N
                    break
                  case '=':
              ...
              return (
                (x = void 0 === x ? 6 : /[gprs]/.test(b) ? Math.max(1, Math.min(21, x)) : Math.max(0, Math.min(20, x))),
                (A.toString = function () {
                  return t + ''
                }),
                A
        ...
        9928: (t, n, e) => {
          ...
          function x(t) {
            return function (n, e) {
              var r = t((n = (0, v.Ym)(n)).h, (e = (0, v.Ym)(e)).h),
                i = (0, c.ZP)(n.s, e.s),
                o = (0, c.ZP)(n.l, e.l),
          ...
          function S(t) {
            return (function n(e) {
              function r(n, r) {
                var i = t((n = (0, N.Z)(n)).h, (r = (0, N.Z)(r)).h),
                  o = (0, c.ZP)(n.s, r.s),
                  s = (0, c.ZP)(n.l, r.l),
        ...
        6773: (t, n, e) => {
          ...
          function s(t, n) {
            ...
            for (t += '', n += ''; (e = i.exec(t)) && (s = o.exec(n)); )
              (a = s.index) > u && ((a = n.slice(u, a)), l[c] ? (l[c] += a) : (l[++c] = a)),
                (e = e[0]) === (s = s[0])
                  ? l[c]
                    ? (l[c] += s)
                    : (l[++c] = s)
                ...
                (u = o.lastIndex)
            return (
              u < n.length && ((a = n.slice(u)), l[c] ? (l[c] += a) : (l[++c] = a)),
              l.length < 2
                ? h[0]
                  ? (function (t) {
                      return function (n) {
              ...
              function (t) {
                return null == t
                  ...
                  : (r || (r = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
                    ...
                    (t = r.transform.baseVal.consolidate()) ? a((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : s)
              },
              ', ',
              ')',
              ')'
          ...
          const i = (function t(n, e, i) {
            function o(t, o) {
              ...
              if (_ < 1e-12)
                ...
                var m = Math.sqrt(_),
                  g = (p * p - l * l + i * _) / (2 * l * e * m),
                  v = (p * p - l * l - i * _) / (2 * p * e * m),
                ...
                ;(a = (w - x) / n),
                  (s = function (t) {
                    var i,
                      ...
                      h =
                        (l / (e * m)) *
                        (s * ((i = n * o + x), ((i = Math.exp(2 * i)) - 1) / (i + 1)) -
                          (function (t) {
                            return ((t = Math.exp(t)) - 1 / t) / 2
                          })(x))
        ...
        8066: (t, n, e) => {
          ...
          function l() {
            ...
            function d() {
              var e = i().length,
                ...
                c = r ? a : s,
                l = r ? s : a
              ;(t = (l - c) / Math.max(1, e - h + 2 * f)),
                u && (t = Math.floor(t)),
                (c += (l - c - t * (e - h)) * p),
                (n = t * (1 - h)),
                u && ((c = Math.round(c)), (n = Math.round(n)))
          ...
          function m(t, n, e) {
            ...
            if ((t = +t) == (n = +n)) return [t]
            const r = n < t,
              [i, o, s] = r ? _(n, t, e) : _(t, n, e)
            if (!(o >= i)) return []
            const a = o - i + 1,
              u = new Array(a)
            if (r)
              if (s < 0) for (let t = 0; t < a; ++t) u[t] = (o - t) / -s
              else for (let t = 0; t < a; ++t) u[t] = (o - t) * s
            else if (s < 0) for (let t = 0; t < a; ++t) u[t] = (i + t) / -s
            else for (let t = 0; t < a; ++t) u[t] = (i + t) * s
            return u
          }
          function g(t, n, e) {
            return _((t = +t), (n = +n), (e = +e))[2]
          }
          function v(t, n, e) {
            e = +e
            const r = (n = +n) < (t = +t),
          ...
          function C(t, n, e) {
            var r = t[0],
              ...
              s = n[1]
            return (
              i < r ? ((r = Z(i, r)), (o = e(s, o))) : ((r = Z(r, i)), (o = e(o, s))),
              function (t) {
                return o(r(t))
              }
            )
          ...
          function H(t, n, e) {
            ...
            for (t[r] < t[0] && ((t = t.slice().reverse()), (n = n.slice().reverse())); ++s < r; )
              (i[s] = Z(t[s], t[s + 1])), (o[s] = e(n[s], n[s + 1]))
            return function (n) {
              var e = A(t, n, 1, r) - 1
              return o[e](i[e](n))
            }
          ...
          function q(t, n, e, r) {
            var i,
              o = v(t, n, e)
            switch ((r = (0, Y.Z)(null == r ? ',f' : r)).type) {
              case 's':
                var s = Math.max(Math.abs(t), Math.abs(n))
                return null != r.precision || isNaN((i = (0, z.Z)(o, s))) || (r.precision = i), (0, F.jH)(r, s)
              case '':
              case 'e':
              case 'g':
              case 'p':
              case 'r':
                null != r.precision ||
                  isNaN((i = (0, U.Z)(o, Math.max(Math.abs(t), Math.abs(n))))) ||
                  (r.precision = i - ('e' === r.type))
                break
              case 'f':
              case '%':
                null != r.precision || isNaN((i = (0, R.Z)(o))) || (r.precision = i - 2 * ('%' === r.type))
            }
            return (0, F.WU)(r)
          }
          function X(t) {
            ...
            return (
              ...
              (t.nice = function (e) {
                ...
                for (c < u && ((i = u), (u = c), (c = i), (i = s), (s = a), (a = i)); l-- > 0; ) {
                  if ((i = g(u, c, e)) === r) return (o[s] = u), (o[a] = c), n(o)
          ...
          function V(t) {
            ...
            return (
              ...
              (t = arguments.length ? Array.from(t, O) : [0, 1]),
              X(e)
            )
          }
          function W(t, n) {
            ...
            return (
              ...
              (n.tickFormat = (t, e) => {
                if (
                  ...
                  null == e && (e = 10 === o ? 's' : ','),
                  'function' != typeof e &&
                    (o % 1 || null != (e = (0, Y.Z)(e)).precision || (e.trim = !0), (e = (0, F.WU)(e))),
                  t === 1 / 0)
                )
                  return e
              ...
              (n.nice = () => e(W(e(), { floor: (t) => i(Math.floor(r(t))), ceil: (t) => i(Math.ceil(r(t))) }))),
              n
            )
          }
          function rt() {
            const t = et($()).domain([1, 10])
            return (t.copy = () => D(t, rt()).base(t.base())), r.apply(t, arguments), t
          }
          function it(t) {
            return function (n) {
          ...
          function at() {
            ...
            return (
              (t.copy = function () {
                return D(t, at()).constant(t.constant())
              }),
              r.apply(t, arguments)
            )
          }
          ...
          function ht(t) {
            ...
            return (
              (n.exponent = function (n) {
                return arguments.length ? (1 == (e = +n) ? t(I, I) : 0.5 === e ? t(ct, lt) : t(ut(e), ut(1 / e))) : e
              }),
              X(n)
            )
          }
          function ft() {
            ...
            return (
              (t.copy = function () {
                return D(t, ft()).exponent(t.exponent())
              }),
              r.apply(t, arguments),
              t
            )
            ...
            for (
              ...
              if (r - e > 600) {
                ...
                vt(
                  ...
                  Math.min(r, Math.floor(n + ((o - s) * u) / o + c)),
                  i
                )
              }
              const o = t[n]
          ...
          function bt() {
            ...
            function s(n) {
              return null == n || isNaN((n = +n)) ? t : e[A(i, n)]
            }
            return (
          ...
          function Mt() {
            var t,
              ...
              s = [0, 1]
            function a(n) {
              return null != n && n <= n ? s[A(o, n, 0, i)] : t
            }
            function u() {
              var t = -1
          ...
          function Tt() {
            var t,
              ...
              i = 1
            function o(r) {
              return null != r && r <= r ? e[A(n, r, 0, i)] : t
            }
            return (
              (o.domain = function (t) {
          ...
          function It(t, n, e, r) {
            ...
            return (
              ...
              e &&
                ((i.count = (n, r) => (Ot.setTime(+n), Lt.setTime(+r), t(Ot), t(Lt), Math.floor(e(Ot, Lt)))),
                (i.every = (t) => (
                  (t = Math.floor(t)),
                  isFinite(t) && t > 0
                    ? t > 1
          ...
          const Ct = It(
            ...
            Yt =
              ...
              It(
                ...
                (t, n) => (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * kt) / Nt,
                (t) => t.getDate() - 1
              )),
            zt =
              (Yt.range,
          ...
          Rt.range, qt.range, Xt.range, Bt.range, Vt.range, Wt.range, Gt.range
          const Qt = Jt(0),
            Kt = Jt(1),
            tn = Jt(2),
            nn = Jt(3),
          ...
          function ln(t, n, e, r, i, o) {
            ...
            function a(n, e, r) {
              const i = Math.abs(e - n) / r,
                o = b(([, , t]) => t).right(s, i)
              if (o === s.length) return t.every(v(n / Pt, e / Pt, r))
              if (0 === o) return Zt.every(Math.max(v(n, e, r), 1))
          ...
          ;(cn.every = (t) =>
            isFinite((t = Math.floor(t))) && t > 0
              ...
              : null),
            cn.range
          const [hn, fn] = ln(cn, an, Qt, Ft, jt, Dt),
            [pn, dn] = ln(un, sn, Rt, Yt, $t, Ht)
          function yn(t) {
            if (0 <= t.y && t.y < 100) {
          ...
          function Qn(t, n) {
            return En(1 + Yt.count(un(t), t), n, 3)
          }
          function Kn(t, n) {
          ...
          function oe(t, n) {
            return En(Rt.count(un(t) - 1, t), n, 2)
          }
          function se(t) {
            var n = t.getDay()
          ...
          function ge(t, n) {
            return En(1 + zt.count(cn(t), t), n, 3)
          }
          function ve(t, n) {
          ...
          function Ye(t, n, e, r, i, o, s, a, u, c) {
            var l = j(),
              h = l.invert,
              f = l.domain,
              p = c('.%L'),
            ...
            return (
              ...
              (l.copy = function () {
                return D(l, Ye(t, n, e, r, i, o, s, a, u, c))
              }),
              l
            )
          }
          function ze() {
            return r.apply(
              Ye(pn, dn, un, sn, Rt, Yt, $t, Ht, Ct, vn).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
              arguments
            )
          }
          function Fe() {
            return r.apply(
              Ye(hn, fn, cn, an, Qt, zt, jt, Dt, Ct, xn).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
              arguments
            )
          }
          function Ue() {
            ...
            function c(n) {
              return null == n || isNaN((n = +n))
                ? i
                : a(0 === e ? 0.5 : ((n = (r(n) - t) * e), u ? Math.max(0, Math.min(1, n)) : n))
            }
            function l(t) {
              return function (n) {
                var e, r
            ...
            return (
              (c.domain = function (i) {
                return arguments.length
                  ? (([o, s] = i), (t = r((o = +o))), (n = r((s = +s))), (e = t === n ? 0 : 1 / (n - t)), c)
                  : [o, s]
              }),
              (c.clamp = function (t) {
          ...
          function Xe() {
            var t = et(Ue()).domain([1, 10])
            return (
              (t.copy = function () {
                return Re(t, Xe()).base(t.base())
              }),
              i.apply(t, arguments)
            )
          }
          function Be() {
            ...
            return (
              (t.copy = function () {
                return Re(t, Be()).constant(t.constant())
              }),
              i.apply(t, arguments)
            )
          }
          ...
          function We() {
            return Ve.apply(null, arguments).exponent(0.5)
          }
          function Ge() {
            var t = [],
              n = I
            function e(e) {
              if (null != e && !isNaN((e = +e))) return n((A(t, e, 1) - 1) / (t.length - 1))
            }
            return (
              (e.domain = function (n) {
                  ...
                  (function (t, n, e) {
                    if (
                      ...
                      var r,
                        i = (r - 1) * n,
                        o = Math.floor(i),
                        s = _t(vt(t, o).subarray(0, o + 1))
                      return s + (mt(t.subarray(o + 1)) - s) * (i - o)
                    }
                  })(t, r / n)
                )
              }),
            ...
            var n = t.dateTime,
              ...
              w = {
                ...
                b: function (t, n, e) {
                  ...
                  return r ? ((t.m = g.get(r[0].toLowerCase())), e + r[0].length) : -1
                },
                B: function (t, n, e) {
            ...
            function b(t, n) {
              return function (e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++a < c; )
                  37 === t.charCodeAt(a) &&
                    (s.push(t.slice(u, a)),
                    null != (i = wn[(r = t.charAt(++a))]) ? (r = t.charAt(++a)) : (i = 'e' === r ? ' ' : '0'),
                    (o = n[r]) && (r = o(e, i)),
                    s.push(r),
                    (u = a + 1))
            ...
            function M(t, n) {
              return function (e) {
                ...
                if (
                  ...
                  'w' in o || (o.w = 1),
                    'Z' in o
                      ? ((i = (r = _n(mn(o.y, 0, 1))).getUTCDay()),
                        (r = i > 4 || 0 === i ? Kt.ceil(r) : Kt(r)),
                        (r = zt.offset(r, 7 * (o.V - 1))),
                        (o.y = r.getUTCFullYear()),
                        (o.m = r.getUTCMonth()),
                        (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
                      : ((i = (r = yn(mn(o.y, 0, 1))).getDay()),
                        (r = i > 4 || 0 === i ? qt.ceil(r) : qt(r)),
                        (r = Yt.offset(r, 7 * (o.V - 1))),
                        (o.y = r.getFullYear()),
                        (o.m = r.getMonth()),
                  ...
                  ('W' in o || 'U' in o) &&
                    ...
                    (i = 'Z' in o ? _n(mn(o.y, 0, 1)).getUTCDay() : yn(mn(o.y, 0, 1)).getDay()),
                    (o.m = 0),
                    (o.d = 'W' in o ? ((o.w + 6) % 7) + 7 * o.W - ((i + 5) % 7) : o.w + 7 * o.U - ((i + 6) % 7)))
                return 'Z' in o ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), _n(o)) : yn(o)
              }
            }
            function T(t, n, e, r) {
          ...
          function Qe() {
            ...
            function p(t) {
              return isNaN((t = +t))
                ? s
                : ((t = 0.5 + ((t = +o(t)) - n) * (l * t < l * n ? r : i)), h(f ? Math.max(0, Math.min(1, t)) : t))
            }
            function d(t) {
              return function (n) {
                var e, r, i
                return arguments.length ? (([e, r, i] = n), (h = (0, Je.Z)(t, [e, r, i])), p) : [h(0), h(0.5), h(1)]
              }
            }
            return (
              (p.domain = function (s) {
          ...
          function tr() {
            var t = et(Qe()).domain([0.1, 1, 10])
            return (
              (t.copy = function () {
                return Re(t, tr()).base(t.base())
              }),
              i.apply(t, arguments)
            )
          }
          function nr() {
            ...
            return (
              (t.copy = function () {
                return Re(t, nr()).constant(t.constant())
              }),
              i.apply(t, arguments)
            )
          }
        ...
        3905: (t, n, e) => {
          ...
          function d(t, n) {
            return (
              t.target && ((t = (0, p.Z)(t)), void 0 === n && (n = t.currentTarget), (t = t.touches || [t])),
          ...
          function m(t) {
            return 'string' == typeof t
              ? new _.Y1([document.querySelectorAll(t)], [document.documentElement])
          ...
          function i(t, n) {
            if (((t = (0, r.Z)(t)), void 0 === n && (n = t.currentTarget), n)) {
              ...
              if (e.createSVGPoint) {
                ...
                return (
                  (i.x = t.clientX), (i.y = t.clientY), [(i = i.matrixTransform(n.getScreenCTM().inverse())).x, i.y]
                )
              }
        ...
        6740: (t, n, e) => {
          ...
          function p(t, n, e, r, i, o) {
            for (var s, a = 0, u = n.length, c = o.length; a < c; ++a)
              (s = n[a]) ? ((s.__data__ = o[a]), (r[a] = s)) : (e[a] = new f(t, o[a]))
          ...
          function d(t, n, e, r, i, o, s) {
            var a,
              ...
              d = new Array(h)
            for (a = 0; a < h; ++a)
              (u = n[a]) && ((d[a] = c = s.call(u, u.__data__, a, n) + ''), l.has(c) ? (i[a] = u) : l.set(c, u))
            for (a = 0; a < p; ++a)
              (c = s.call(t, o[a], a, o) + ''),
                (u = l.get(c)) ? ((r[a] = u), (u.__data__ = o[a]), l.delete(c)) : (e[a] = new f(t, o[a]))
          ...
          function it() {
            return new rt([[document.documentElement]], et)
          }
          rt.prototype = it.prototype = {
            ...
            select: function (t) {
              ...
              for (var n = this._groups, e = n.length, i = new Array(e), o = 0; o < e; ++o)
                for (var s, a, u = n[o], c = u.length, l = (i[o] = new Array(c)), h = 0; h < c; ++h)
                  (s = u[h]) &&
            ...
            selectAll: function (t) {
              ...
              for (var n = this._groups, e = n.length, r = [], s = [], a = 0; a < e; ++a)
                for (var u, c = n[a], l = c.length, h = 0; h < l; ++h)
                  (u = c[h]) && (r.push(t.call(u, u.__data__, h, c)), s.push(u))
              return new rt(r, s)
            },
            ...
            filter: function (t) {
              ...
              for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
                for (var o, a = n[i], u = a.length, c = (r[i] = []), l = 0; l < u; ++l)
                  (o = a[l]) && t.call(o, o.__data__, l, a) && c.push(o)
            ...
            data: function (t, n) {
              ...
              for (var s = o.length, a = new Array(s), u = new Array(s), c = new Array(s), l = 0; l < s; ++l) {
                var h = i[l],
                  f = o[l],
                  m = f.length,
                  g = _(t.call(h, h && h.__data__, l, i)),
                  v = g.length,
                  x = (u[l] = new Array(v)),
                  w = (a[l] = new Array(v))
                r(h, f, x, w, (c[l] = new Array(m)), g, n)
                for (var b, M, T = 0, E = 0; T < v; ++T)
                  if ((b = x[T])) {
                    for (T >= E && (E = T + 1); !(M = w[E]) && ++E < v; );
                    b._next = M || null
                  }
              }
            ...
            merge: function (t) {
              for (
                ...
                for (var c, l = e[u], h = r[u], f = l.length, p = (a[u] = new Array(f)), d = 0; d < f; ++d)
                  (c = l[d] || h[d]) && (p[d] = c)
              for (; u < i; ++u) a[u] = e[u]
            ...
            order: function () {
              for (var t = this._groups, n = -1, e = t.length; ++n < e; )
                for (var r, i = t[n], o = i.length - 1, s = i[o]; --o >= 0; )
                  (r = i[o]) && (s && 4 ^ r.compareDocumentPosition(s) && s.parentNode.insertBefore(r, s), (s = r))
              return this
            },
            sort: function (t) {
              function n(n, e) {
              ...
              for (var e = this._groups, r = e.length, i = new Array(r), o = 0; o < r; ++o) {
                for (var s, a = e[o], u = a.length, c = (i[o] = new Array(u)), l = 0; l < u; ++l)
                  (s = a[l]) && (c[l] = s)
                c.sort(n)
              }
            ...
            attr: function (t, n) {
              ...
              return this.each(
                (null == n ? (e.local ? x : v) : 'function' == typeof n ? (e.local ? T : M) : e.local ? b : w)(e, n)
              )
            },
            style: E.Z,
            property: function (t, n) {
              return arguments.length > 1
                ? this.each((null == n ? k : 'function' == typeof n ? N : A)(t, n))
                : this.node()[t]
            },
            classed: function (t, n) {
              var e = S(t + '')
              if (arguments.length < 2) {
                for (var r = P(this.node()), i = -1, o = e.length; ++i < o; ) if (!r.contains(e[i])) return !1
                return !0
              }
              return this.each(('function' == typeof n ? H : n ? Z : C)(e, n))
            },
            text: function (t) {
              return arguments.length
                ? this.each(null == t ? D : ('function' == typeof t ? j : $)(t))
                : this.node().textContent
            },
            html: function (t) {
              return arguments.length
                ? this.each(null == t ? Y : ('function' == typeof t ? F : z)(t))
                : this.node().innerHTML
            },
            raise: function () {
              return this.each(U)
            ...
            on: function (t, n, e) {
              ...
              if (a)
                for (var u, c = 0, l = a.length; c < l; ++c)
                  for (r = 0, u = a[c]; r < s; ++r) if ((i = o[r]).type === u.type && i.name === u.name) return u.value
            },
        ...
        2627: (t, n, e) => {
          ...
          function a(t, n, e) {
            return arguments.length > 1
              ? this.each((null == n ? i : 'function' == typeof n ? s : o)(t, n, null == e ? '' : e))
              : u(this.node(), t)
          }
          function u(t, n) {
        ...
        6660: (t, n, e) => {
          ...
          e.r(n),
            e.d(n, {
              ...
              radialLine: () => q,
              stack: () => kn,
              stackOffsetDiverging: () => Nn,
              stackOffsetExpand: () => An,
              stackOffsetNone: () => bn,
              ...
              stackOrderInsideOut: () => Hn,
              stackOrderNone: () => Mn,
              stackOrderReverse: () => Dn,
              symbol: () => Lt,
              symbolAsterisk: () => st,
              symbolCircle: () => at,
              symbolCross: () => ut,
          ...
          class w {
              ...
              if (null === this._x1) this._append`M${(this._x1 = t)},${(this._y1 = n)}`
                ...
                if (Math.abs(l * a - u * c) > g && i) {
                  let f = e - o,
                    ...
                    m = Math.sqrt(d),
                    v = Math.sqrt(h),
                    x = i * Math.tan((_ - Math.acos((d + h - y) / (2 * m * v))) / 2),
                    w = x / v,
                    b = x / m
                  Math.abs(w - 1) > g && this._append`L${t + w * c},${n + w * l}`,
                    this._append`A${i},${i},0,0,${+(l * f > c * p)},${(this._x1 = t + b * a)},${(this._y1 = n + b * u)}`
            ...
            arc(t, n, e, r, i, o) {
              ...
              null === this._x1
                ? this._append`M${u},${c}`
                : (Math.abs(this._x1 - u) > g || Math.abs(this._y1 - c) > g) && this._append`L${u},${c}`,
                e &&
                  (h < 0 && (h = (h % m) + m),
                  h > v
                    ? this
                        ._append`A${e},${e},0,1,${l},${t - s},${n - a}A${e},${e},0,1,${l},${(this._x1 = u)},${(this._y1 = c)}`
                    : h > g &&
                      this
                        ._append`A${e},${e},0,${+(h >= _)},${l},${(this._x1 = t + e * Math.cos(i))},${(this._y1 = n + e * Math.sin(i))}`)
            }
            rect(t, n, e, r) {
          ...
          function N(t, n, e, r, i, o, s) {
            var u = t - e,
              ...
              I = S - v
            return (
              P * P + O * O > L * L + I * I && ((k = N), (A = S)),
              { cx: k, cy: A, x01: -f, y01: -p, x11: k * (i / M - 1), y11: A * (i / M - 1) }
            )
          }
          function S() {
            var t = M,
            ...
            function w() {
              var r,
                ...
                E = _.apply(this, arguments) - p,
                k = m.apply(this, arguments) - p,
                A = i(k - E),
                S = k > E
              if ((v || (v = r = x()), T < M && ((w = T), (T = M), (M = w)), T > h))
                if (A > d - h)
                  v.moveTo(T * s(E), T * c(E)),
                    v.arc(0, 0, T, E, k, !S),
                    M > h && (v.moveTo(M * s(k), M * c(k)), v.arc(0, 0, M, k, E, S))
                else {
                  var P,
                    O,
                    L = E,
                    ...
                    H = A,
                    D = A,
                    $ = g.apply(this, arguments) / 2,
                    j = $ > h && (a ? +a.apply(this, arguments) : l(M * M + T * T)),
                    Y = u(i(T - M) / 2, +e.apply(this, arguments)),
                    z = Y,
                    F = Y
                  if (j > h) {
                    var U = y((j / M) * c($)),
                      R = y((j / T) * c($))
                    ;(H -= 2 * U) > h ? ((Z += U *= S ? 1 : -1), (C -= U)) : ((H = 0), (Z = C = (E + k) / 2)),
                      (D -= 2 * R) > h ? ((L += R *= S ? 1 : -1), (I -= R)) : ((D = 0), (L = I = (E + k) / 2))
                  }
                  var q = T * s(L),
                    X = T * c(L),
                    B = M * s(C),
                      ...
                      if (
                        ...
                        var tt = q - W[0],
                          ...
                          it =
                            1 /
                            c(
                              ((b = (tt * et + nt * rt) / (l(tt * tt + nt * nt) * l(et * et + rt * rt))) > 1
                                ? 0
                                : b < -1
                                  ? f
                                  : Math.acos(b)) / 2
                        ...
                        ;(z = u(Y, (M - ot) / (it - 1))), (F = u(Y, (T - ot) / (it + 1)))
                      } else z = F = 0
                  }
                  D > h
                    ? F > h
                      ? ((P = N(Q, K, q, X, T, F, S)),
                        (O = N(G, J, B, V, T, F, S)),
                        v.moveTo(P.cx + P.x01, P.cy + P.y01),
                        F < Y
                          ? v.arc(P.cx, P.cy, F, o(P.y01, P.x01), o(O.y01, O.x01), !S)
                          : (v.arc(P.cx, P.cy, F, o(P.y01, P.x01), o(P.y11, P.x11), !S),
                            v.arc(0, 0, T, o(P.cy + P.y11, P.cx + P.x11), o(O.cy + O.y11, O.cx + O.x11), !S),
                            v.arc(O.cx, O.cy, F, o(O.y11, O.x11), o(O.y01, O.x01), !S)))
                      : (v.moveTo(q, X), v.arc(0, 0, T, L, I, !S))
                    : v.moveTo(q, X),
                    M > h && H > h
                      ? z > h
                        ? ((P = N(B, V, G, J, M, -z, S)),
                          (O = N(q, X, Q, K, M, -z, S)),
                          v.lineTo(P.cx + P.x01, P.cy + P.y01),
                          z < Y
                            ? v.arc(P.cx, P.cy, z, o(P.y01, P.x01), o(O.y01, O.x01), !S)
                            : (v.arc(P.cx, P.cy, z, o(P.y01, P.x01), o(P.y11, P.x11), !S),
                              v.arc(0, 0, M, o(P.cy + P.y11, P.cx + P.x11), o(O.cy + O.y11, O.cx + O.x11), S),
                              v.arc(O.cx, O.cy, z, o(O.y11, O.x11), o(O.y01, O.x01), !S)))
                        : v.arc(0, 0, M, C, Z, S)
                      : v.lineTo(B, V)
                }
              else v.moveTo(0, 0)
              if ((v.closePath(), r)) return (v = null), r + '' || null
            }
            return (
              (w.centroid = function () {
                var e = (+t.apply(this, arguments) + +n.apply(this, arguments)) / 2,
                  r = (+_.apply(this, arguments) + +m.apply(this, arguments)) / 2 - f / 2
                return [s(r) * e, c(r) * e]
              }),
              ...
              (w.padAngle = function (t) {
                return arguments.length ? ((g = 'function' == typeof t ? t : r(+t)), w) : g
              }),
              (w.context = function (t) {
                return arguments.length ? ((v = null == t ? null : t), w) : v
              }),
              w
            )
          }
          ...
          function H(t, n) {
            ...
            function u(r) {
              var u,
                ...
                h = (r = O(r)).length,
                f = !1
              for (null == i && (s = o((l = a()))), u = 0; u <= h; ++u)
                !(u < h && e((c = r[u]), u, r)) === f && ((f = !f) ? s.lineStart() : s.lineEnd()),
                  f && s.point(+t(c, u, r), +n(c, u, r))
              if (l) return (s = null), l + '' || null
            }
            return (
              (t = 'function' == typeof t ? t : void 0 === t ? Z : r(t)),
              (n = 'function' == typeof n ? n : void 0 === n ? C : r(n)),
              (u.x = function (n) {
          ...
          function D(t, n, e) {
            ...
            function l(r) {
              ...
              for (null == s && (u = a((d = c()))), l = 0; l <= y; ++l) {
                if (!(l < y && o((p = r[l]), l, r)) === _)
                  if ((_ = !_)) (h = l), u.areaStart(), u.lineStart()
                  else {
                    for (u.lineEnd(), u.lineStart(), f = l - 1; f >= h; --f) u.point(m[f], g[f])
                    u.lineEnd(), u.areaEnd()
                  }
                _ &&
                  ((m[l] = +t(p, l, r)), (g[l] = +n(p, l, r)), u.point(i ? +i(p, l, r) : m[l], e ? +e(p, l, r) : g[l]))
              }
              if (d) return (u = null), d + '' || null
            }
            function h() {
              return H().defined(o).curve(a).context(s)
            }
            return (
              (t = 'function' == typeof t ? t : void 0 === t ? Z : r(+t)),
              (n = 'function' == typeof n ? n : r(void 0 === n ? 0 : +n)),
              (e = 'function' == typeof e ? e : void 0 === e ? C : r(+e)),
              (l.x = function (n) {
          ...
          function Y() {
            ...
            function a(r) {
              var a,
                ...
                g = Math.min(d, Math.max(-d, o.apply(this, arguments) - m)),
                v = Math.min(Math.abs(g) / f, s.apply(this, arguments)),
                x = v * (g < 0 ? -1 : 1)
              for (a = 0; a < f; ++a) (h = _[(y[a] = a)] = +t(r[a], a, r)) > 0 && (p += h)
              for (
                null != n
                  ? y.sort(function (t, e) {
                      return n(_[t], _[e])
                ...
                (u = y[a]),
                  (l = m + ((h = _[u]) > 0 ? h * c : 0) + x),
                  (_[u] = { data: r[u], index: a, value: h, startAngle: m, endAngle: l, padAngle: v })
              return _
            }
            return (
              (a.value = function (n) {
          ...
          function nt(t) {
            ...
            function c() {
              ...
              if (
                ...
                a.lineStart(),
                (c[0] = l),
                a.point(+i.apply(this, c), +o.apply(this, c)),
                (c[0] = h),
                a.point(+i.apply(this, c), +o.apply(this, c)),
                a.lineEnd(),
                r)
          ...
          const ot = l(3),
            st = {
              draw(t, n) {
                const e = 0.59436 * l(n + u(n / 28, 0.75)),
                  r = e / 2,
                  i = r * ot
            ...
            vt = {
              draw(t, n) {
                const e = l(0.8908130915292852 * n),
                  r = mt * e,
                  i = gt * e
            ...
            Nt = {
              draw(t, n) {
                ...
                t.moveTo(r, i),
                  t.lineTo(o, s),
                  t.lineTo(a, u),
                  t.lineTo(Tt * r - Et * i, Et * r + Tt * i),
                  t.lineTo(Tt * o - Et * s, Et * o + Tt * s),
                  t.lineTo(Tt * a - Et * u, Et * a + Tt * u),
                  t.lineTo(Tt * r + Et * i, Tt * i - Et * r),
                  t.lineTo(Tt * o + Et * s, Tt * s - Et * o),
                  t.lineTo(Tt * a + Et * u, Tt * u - Et * a),
                  t.closePath()
              }
            },
            St = {
              draw(t, n) {
                const e = 0.6189 * l(n - u(n / 6, 1.7))
                t.moveTo(-e, -e), t.lineTo(e, e), t.moveTo(-e, e), t.lineTo(e, -e)
              }
            },
            Pt = [at, ut, ht, dt, vt, wt, Nt],
          ...
          function Lt(t, n) {
            ...
            function o() {
              let r
              if ((e || (e = r = i()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r))
                return (e = null), r + '' || null
            }
            return (
              (t = 'function' == typeof t ? t : r(t || at)),
              (n = 'function' == typeof n ? n : r(void 0 === n ? 64 : +n)),
              (o.type = function (n) {
            ...
            (zt.prototype = {
              ...
              lineEnd: function () {
                var t = this._x,
                  ...
                  e = t.length - 1
                if (e > 0)
                  for (var r, i = t[0], o = n[0], s = t[e] - i, a = n[e] - o, u = -1; ++u <= e; )
                    (r = u / e),
                      this._basis.point(
                        this._beta * t[u] + (1 - this._beta) * (i + r * s),
                        this._beta * n[u] + (1 - this._beta) * (o + r * a)
                      )
          ...
          const Ft = (function t(n) {
            function e(t) {
              return 1 === n ? new Ct(t) : new zt(t, n)
            }
            return (
              (e.beta = function (n) {
                return t(+n)
          ...
          const Qt = (function t(n) {
            function e(t) {
              return n ? new Jt(t, n) : new Rt(t, 0)
            }
            return (
              (e.alpha = function (n) {
                return t(+n)
          ...
          function an(t, n, e) {
            var r = t._x1 - t._x0,
              ...
              s = (e - t._y1) / (i || (r < 0 && -0)),
              a = (o * i + s * r) / (r + i)
            return (sn(o) + sn(s)) * Math.min(Math.abs(o), Math.abs(s), 0.5 * Math.abs(a)) || 0
          }
          function un(t, n) {
            var e = t._x1 - t._x0
          ...
          function _n(t) {
            ...
            for (i[r - 1] = 2, o[r - 1] = 7, s[r - 1] = 8 * t[r - 1] + t[r], n = 1; n < r; ++n)
          ...
          function kn() {
            ...
            function o(r) {
              var o,
                s,
                a = Array.from(t.apply(this, arguments), En),
                u = a.length,
                c = -1
              for (const t of r) for (o = 0, ++c; o < u; ++o) (a[o][c] = [0, +i(t, a[o].key, c, r)]).data = t
              ...
              lineEnd: function () {
                ...
                if (e)
                  if ((this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e))
                    ...
                    for (var r = _n(t), i = _n(n), o = 0, s = 1; s < e; ++o, ++s)
                      this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[s], n[s])
        ...
        9065: (t, n, e) => {
          'use strict'
          e.r(n), e.d(n, { ZoomTransform: () => Nt, zoom: () => jt, zoomIdentity: () => St, zoomTransform: () => Pt })
          var r = { value: () => {} }
          function i() {
          ...
          o.prototype = i.prototype = {
            ...
            on: function (t, n) {
              ...
              for (; ++u < c; ) if ((e = (t = o[u]).type) && (e = s(i[e], t.name))) return e
            },
            copy: function () {
              var t = {},
                n = this._
                ...
                (function () {
                  for (var t, n, e = f, r = 1 / 0; e; )
                    e._call
                      ...
                      : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (f = n)))
                  ;(p = t), L(r)
                })(),
                (b = 0)
            }
          ...
          function L(t) {
            m ||
              (g && (g = clearTimeout(g)),
              t - b > 24
                ? (t < 1 / 0 && (g = setTimeout(P, t - T.now() - M)), v && (v = clearInterval(v)))
                : (v || ((w = T.now()), (v = setInterval(O, x))), (m = 1), E(P)))
          }
          function I(t, n, e) {
            var r = new N()
            return (
          ...
          N.prototype = S.prototype = {
            ...
            restart: function (t, n, e) {
              ...
              ;(e = (null == e ? k() : +e) + (null == n ? 0 : +n)),
                this._next || p === this || (p ? (p._next = this) : (f = this), (p = this)),
                (this._call = t),
                (this._time = e),
                L()
            },
            ...
            !(function (t, n, e) {
              ...
              function o(u) {
                ...
                if (
                  ...
                  for (e.state = $, r = new Array((h = e.tween.length)), c = 0, l = -1; c < h; ++c)
              ...
              function s(n) {
                for (
                  var i = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(a), (e.state = j), 1),
                    o = -1,
                    s = r.length;
                  ++o < s;
              ...
              function a() {
                for (var r in ((e.state = Y), e.timer.stop(), delete i[n], i)) return
          ...
          function W(t, n, e) {
            ...
            return function () {
              ...
              if (s !== r) {
                i = (r = s).slice()
                for (var a = { name: n, value: e }, u = 0, c = i.length; u < c; ++u)
                  if (i[u].name === n) {
                    i[u] = a
                    break
                  }
          ...
          function nt(t, n) {
            var e
            return (
              'number' == typeof n ? Q.Z : n instanceof J.ZP ? K.ZP : (e = (0, J.ZP)(n)) ? ((n = e), K.ZP) : tt.Z
            )(t, n)
          }
          function et(t) {
            return function () {
          ...
          function at(t, n, e) {
            ...
            return function () {
              var s,
                ...
                u = e(this)
              if (null != u)
                return (s = this.getAttributeNS(t.space, t.local)) === (a = u + '')
                  ? null
                  : s === r && a === i
                    ? o
                    : ((i = a), (o = n((r = s), u)))
          ...
          var Mt = _.ZP.prototype
          wt.prototype = function (t) {
            return (0, _.ZP)().transition(t)
          }.prototype = {
            constructor: wt,
            select: function (t) {
              var n = this._name,
              ...
              for (var r = this._groups, i = r.length, o = new Array(i), s = 0; s < i; ++s)
                for (var a, u, c = r[s], l = c.length, h = (o[s] = new Array(l)), f = 0; f < l; ++f)
                  (a = c[f]) &&
                    (u = t.call(a, a.__data__, f, c)) &&
                    ('__data__' in a && (u.__data__ = a.__data__), (h[f] = u), z(h[f], n, e, f, h, R(a, e)))
              return new wt(o, this._parents, n, e)
            },
            selectAll: function (t) {
              var n = this._name,
                e = this._id
              'function' != typeof t && (t = (0, _t.Z)(t))
              for (var r = this._groups, i = r.length, o = [], s = [], a = 0; a < i; ++a)
                for (var u, c = r[a], l = c.length, h = 0; h < l; ++h)
                  if ((u = c[h])) {
                    for (var f, p = t.call(u, u.__data__, h, c), d = R(u, e), y = 0, _ = p.length; y < _; ++y)
                      (f = p[y]) && z(f, n, e, y, p, d)
                    o.push(p), s.push(u)
                  }
            ...
            filter: function (t) {
              ...
              for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
                for (var o, s = n[i], a = s.length, u = (r[i] = []), c = 0; c < a; ++c)
            ...
            merge: function (t) {
              ...
              for (
                ...
                for (var u, c = n[a], l = e[a], h = c.length, f = (s[a] = new Array(h)), p = 0; p < h; ++p)
                  (u = c[p] || l[p]) && (f[p] = u)
              for (; a < r; ++a) s[a] = n[a]
            ...
            attr: function (t, n) {
              ...
              return this.attrTween(
                t,
                'function' == typeof n
                  ? (e.local ? at : st)(e, r, G(this, 'attr.' + t, n))
                  : null == n
                    ? (e.local ? rt : et)(e)
                    : (e.local ? ot : it)(e, r, n)
              )
              ...
              return null == n
                ? this.styleTween(
                    ...
                    (function (t, n) {
                      ...
                      return function () {
                        var o = (0, gt.S)(this, t),
                          s = (this.style.removeProperty(t), (0, gt.S)(this, t))
                      ...
                      (function (t, n, e) {
                        ...
                        return function () {
                          var s = (0, gt.S)(this, t),
                            ...
                            u = a + ''
                          return (
                            null == a && (this.style.removeProperty(t), (u = a = (0, gt.S)(this, t))),
                            s === u ? null : s === r && u === i ? o : ((i = u), (o = n((r = s), a)))
                          )
                        }
                      })(t, r, G(this, 'style.' + t, n))
                    ).each(
                      (function (t, n) {
                        var e,
                          r,
                        ...
                        return function () {
                          var u = U(this, t),
                            c = u.on,
                            l = null == u.value[s] ? o || (o = vt(n)) : void 0
            ...
            tween: function (t, n) {
              ...
              if (((t += ''), arguments.length < 2)) {
                for (var r, i = R(this.node(), e).tween, o = 0, s = i.length; o < s; ++o)
            ...
            delay: function (t) {
              var n = this._id
              return arguments.length ? this.each(('function' == typeof t ? lt : ht)(n, t)) : R(this.node(), n).delay
            },
            duration: function (t) {
              var n = this._id
              return arguments.length ? this.each(('function' == typeof t ? ft : pt)(n, t)) : R(this.node(), n).duration
            },
            ease: function (t) {
              var n = this._id
              return arguments.length
          ...
          ;(_.ZP.prototype.interrupt = function (t) {
            return this.each(function () {
              q(this, t)
            })
          }),
            (_.ZP.prototype.transition = function (t) {
              var n, e
              t instanceof wt
                ? ((n = t._id), (t = t._name))
                : ((n = bt()), ((e = Tt).time = k()), (t = null == t ? null : t + ''))
              for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
                for (var s, a = r[o], u = a.length, c = 0; c < u; ++c) (s = a[c]) && z(s, t, n, c, a, e || Et(s, n))
              return new wt(r, this._parents, t, n)
            })
          const kt = (t) => () => t
          function At(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
          ...
          Nt.prototype = {
            constructor: Nt,
            scale: function (t) {
              return 1 === t ? this : new Nt(this.k * t, this.x, this.y)
            },
            translate: function (t, n) {
              return (0 === t) & (0 === n) ? this : new Nt(this.k, this.x + this.k * t, this.y + this.k * n)
            },
            apply: function (t) {
          ...
          var St = new Nt(1, 0, 0)
          function Pt(t) {
            for (; !t.__zoom; ) if (!(t = t.parentNode)) return St
            return t.__zoom
          }
          function Ot(t) {
          ...
          function jt() {
            ...
            function T(t, n) {
              return (n = Math.max(f[0], Math.min(f[1], n))) === t.k ? t : new Nt(n, t.x, t.y)
            }
            function E(t, n, e) {
              var r = n[0] - e[0] * t.k,
                i = n[1] - e[1] * t.k
              return r === t.x && i === t.y ? t : new Nt(t.k, r, i)
            }
            function k(t) {
              ...
              t.on('start.zoom', function () {
                ...
                .tween('zoom', function () {
                  var t = this,
                    ...
                    f = m(l.invert(u).concat(c / l.k), h.invert(u).concat(c / h.k))
                  return function (t) {
                    if (1 === t) t = h
                    else {
                      var n = f(t),
                        e = c / n[2]
                      t = new Nt(e, u[0] - n[0] * e, u[1] - n[1] * e)
                    }
                    s.zoom(null, t)
                  }
                })
            ...
            function P(t, ...n) {
              if (r.apply(this, arguments)) {
                var e = N(this, n).event(t),
                  i = this.__zoom,
                  a = Math.max(f[0], Math.min(f[1], i.k * Math.pow(2, s.apply(this, arguments)))),
                  u = (0, y.Z)(t)
                if (e.wheel)
                  (e.mouse[0][0] === u[0] && e.mouse[0][1] === u[1]) || (e.mouse[1] = i.invert((e.mouse[0] = u))),
                ...
                Lt(t),
                  ...
                  e.zoom('mouse', o(E(T(i, a), e.mouse[0], e.mouse[1]), e.extent, p))
              }
            }
            function O(t, ...n) {
              if (!e && r.apply(this, arguments)) {
                var i = t.currentTarget,
                  s = N(this, n, !0).event(t),
                  a = (0, c.Z)(t.view)
                    .on(
                      'mousemove.zoom',
                      function (t) {
                        ...
                        s.event(t).zoom(
                          'mouse',
                          o(E(s.that.__zoom, (s.mouse[0] = (0, y.Z)(t, i)), s.mouse[1]), s.extent, p)
                        )
                      },
                      !0
                    )
            ...
            function L(t, ...n) {
              if (r.apply(this, arguments)) {
                ...
                Lt(t),
                  _ > 0
                    ? (0, c.Z)(this).transition().duration(_).call(A, l, s, t)
                    : (0, c.Z)(this).call(M.transform, l, s, t)
              }
            }
            function I(e, ...i) {
              if (r.apply(this, arguments)) {
                var o,
                  ...
                  c = e.touches,
                  l = c.length,
                  h = N(this, i, e.changedTouches.length === l).event(e)
                for (Ot(e), s = 0; s < l; ++s)
                  (a = c[s]),
                    (u = [(u = (0, y.Z)(a, this)), this.__zoom.invert(u), a.identifier]),
                    h.touch0
                      ? h.touch1 || h.touch0[2] === u[2] || ((h.touch1 = u), (h.taps = 0))
                      : ((h.touch0 = u), (o = !0), (h.taps = 1 + !!t))
                t && (t = clearTimeout(t)),
                  o &&
                    (h.taps < 2 &&
                      ((n = u[0]),
              ...
              if (this.__zooming) {
                ...
                if (((r = a.that.__zoom), a.touch1)) {
                  var l = a.touch0[0],
                    ...
                    f = a.touch1[0],
                    d = a.touch1[1],
                    _ = (_ = f[0] - l[0]) * _ + (_ = f[1] - l[1]) * _,
                    m = (m = d[0] - h[0]) * m + (m = d[1] - h[1]) * m
                  ;(r = T(r, Math.sqrt(_ / m))),
                    (i = [(l[0] + f[0]) / 2, (l[1] + f[1]) / 2]),
                    (s = [(h[0] + d[0]) / 2, (h[1] + d[1]) / 2])
                } else {
                  if (!a.touch0) return
                ...
                for (
                  ...
                  (o = a[i]),
                    s.touch0 && s.touch0[2] === o.identifier
                      ? delete s.touch0
                      : s.touch1 && s.touch1[2] === o.identifier && delete s.touch1
                if ((s.touch1 && !s.touch0 && ((s.touch0 = s.touch1), delete s.touch1), s.touch0))
                  s.touch0[1] = this.__zoom.invert(s.touch0[0])
                else if (
                  (s.end(), 2 === s.taps && ((o = (0, y.Z)(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < b))
                ) {
            ...
            return (
              ...
              (M.translateExtent = function (t) {
                return arguments.length
                  ? ((p[0][0] = +t[0][0]), (p[1][0] = +t[1][0]), (p[0][1] = +t[0][1]), (p[1][1] = +t[1][1]), M)
                  : [
                      [p[0][0], p[0][1]],
                      [p[1][0], p[1][1]]
                    ]
